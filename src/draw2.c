...
enemy_t enemies[num_enemy] = {
	{79.4, 84.4, 0, "img/enemy_01.png"},
	{250.5, 100, 5, "img/enemy_03.png"},
	{390.5, 205, 5, "img/enemy_04.png"},
	{430, 384, 5, "img/enemy_01.png"},
	{80.3, 445.7, 5, "img/enemy_02.png"}
};
...
void add_weapon(SDL_Instance ins)
{
	...
	SDL_Rect gun;
	int w, h;
	SDL_Surface *surf = IMG_Load("img/shoot.png");
